...
class TableDataNavigationViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        self.dataNavigationView?.action = #selector(TableDataNavigationViewController.toolButtonClicked(_:))
        //配置导航面板的按钮
    ...
    lazy var tableViewScrollView: NSScrollView? = {
        ...
        if tbScollView == nil {
            ...
            tbScollView?.borderType = .bezelBorder
